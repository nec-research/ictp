...
def run_npt(
    ...
    traj_writer = ASETrajectoryWriter('results/' + model + '/trp_eq.traj', simulation, system)
    md_logger = MDLogger('results/' + model + '/trp_eq.csv', simulation, system, write_interval=write_interval, write_density=True)
